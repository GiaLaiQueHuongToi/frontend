  ...
  const generateImagesForScript = async (
    ...
    try {
      toast({
        ...
        description: "Creating visual content for each script segment...",
      });

      console.log("Starting image generation with context:", videoContext);
      ...
      const missingImages = generatedImages.filter((img) => !img.imageUrl);
