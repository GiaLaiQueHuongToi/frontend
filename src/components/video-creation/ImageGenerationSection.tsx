        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <h4 className="font-medium flex items-center gap-2">
              ...
              Generated Images ({imageState.generatedImages.length})
            </h4>
            <div className="flex gap-2">
              <Button size="sm" variant="outline" onClick={onDebugImages}>
                Debug Images
              </Button>
            </div>
          </div>
          ...
          <div className="text-xs text-gray-600 bg-blue-50 p-2 rounded">
            💡 AI images load with {DELAY_INCREMENT / 1000}-second delays to
            avoid rate limits. Each image will appear progressively.
          </div>
        ...
        <div className="flex items-center justify-center p-8 border rounded-lg bg-purple-50">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-purple-600">
              Gemini AI is generating visual content for your script segments...
            </p>
          </div>
        </div>
      )}
