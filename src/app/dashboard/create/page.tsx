...
export default function CreateVideoPage() {
  ...
  const [videoOutline, setVideoOutline] = useState<VideoOutlineResponse | null>(
    null
  );
                    ...
                    <div className="grid grid-cols-1 gap-3 max-h-60 overflow-y-auto">
                      {searchResults.map((result) => (
                        ...
                        >
                          <img
                            src={
                              result.thumbnail || "/placeholder-thumbnail.svg"
                            }
                            alt={result.title}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {selectedAudiencePreview === "students" &&
                          "Young learners seeking educational content"}
                        {selectedAudiencePreview === "professionals" &&
                          "Working adults looking for industry insights"}
                        {selectedAudiencePreview === "general" &&
                          "Broad audience with diverse interests"}
                        {selectedAudiencePreview === "educators" &&
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <ScrollArea className="h-80 border rounded-lg p-4">
                <div className="space-y-4">
                  {videoOutline?.scriptSegments.map((section, index) => (
                    <div key={section.id} className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        {videoOutline?.scriptSegments[section.id - 1] && (
                          <Badge variant="secondary" className="text-xs">
                            {videoOutline.scriptSegments[section.id - 1].start}{" "}
                            - {videoOutline.scriptSegments[section.id - 1].end}s
                          </Badge>
                        )}
                      </div>
                      <Textarea
                        ...
                        value={section.text}
                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
                          updateScriptItem(section.id, e.target.value)
                        }
                        rows={3}
                        className="resize-none text-sm"
                        placeholder={`Enter content for section ${section.id}...`}
                      />
                      {index < videoOutline.scriptSegments.length - 1 && (
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-3 gap-1">
                      {["None", "Vintage", "B&W", "Warm", "Cool", "Bright"].map(
                        (filter) => (
                          <Button
                            key={filter}
                            variant="outline"
          ...
          <Card className="shadow-lg border-0">
            ...
            <CardFooter className="flex justify-between bg-gray-50 px-6 py-4">
              ...
              <Button
                ...
                disabled={
                  (currentStep === 1 && !videoDescription && !selectedTopic) ||
...
//           <div className="space-y-6">
//             <div className="space-y-2">
//               <Label htmlFor="videoDescription">Video Title</Label>
//               <Input
//                 id="videoDescription"
//                 placeholder="Enter a title for your video"
//                 value={videoDescription}
//                 onChange={(e: React.ChangeEvent<HTMLInputElement>) => setVideoDescription(e.target.value)}
//               />
//             </div>
