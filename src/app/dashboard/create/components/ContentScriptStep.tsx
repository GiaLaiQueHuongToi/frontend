  ...
  if (!scriptGeneration.videoOutline) {
    return (
      <div className="text-center space-y-4">
        ...
        <div>
          <h3 className="text-lg font-semibold mb-2">Generate AI Content</h3>
          <p className="text-gray-600 mb-4">
            Let our AI create a compelling script and content outline based on
                ...
                <div key={section.id} className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
                      handleUpdateScriptItem(section.id, e.target.value)
                    }
                    rows={3}
                  ...
                  />
                  {index <
                    (scriptGeneration.videoOutline?.scriptSegments?.length ??
                      0) -
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div className="space-y-2">
              <p>
                ...
                {scriptGeneration.videoOutline.estimatedDuration}s
              </p>
              <p>
