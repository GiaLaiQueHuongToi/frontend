...
export function BasicInformationStep({ state, onUpdateState }: BasicInformationStepProps) {
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 gap-3 max-h-60 overflow-y-auto">
                {[
                  ...
                  { id: 3, title: "Future of Artificial Intelligence", thumbnail: "/placeholder-thumbnail.svg", views: "2.1M" },
                ].map((result) => (
                  <div
                    key={result.id}
                    className="flex gap-3 p-3 border rounded-md hover:bg-gray-50 cursor-pointer"
                    onClick={() => handleTopicSelect(result.title)}
                  >
