...
const mockVideoDetails = {
  ...
  description: "Exploring the most exciting AI trends that will shape the future of technology in 2025.",
        ...
        <div className="lg:col-span-2">
          <Card className="overflow-hidden">
            <div className="aspect-video bg-gray-900 relative flex items-center justify-center">
              ...
              >
                {isPlaying ? (
                  <div className="text-white text-lg">Video is playing...</div>
                ) : (
                  <>
                    <img
                      src={mockVideoDetails.thumbnail || "/placeholder.svg"}
            ...
            <CardContent className="p-4">
              <p className="text-gray-700">{mockVideoDetails.description}</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div>
          <Card>
            <CardContent className="p-4 space-y-4">
              ...
              <Link href={`/dashboard/video/${id}/edit`}>
